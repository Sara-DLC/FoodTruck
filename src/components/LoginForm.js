    ...
    <div className="main">
        ...
        <Form>
            ...
            <Field className="user-field" component="select" name="options" >
                ...
                <option value="Vendor">Food Truck Vendor</option>
...
const FormikUserForm = withFormik({
    ...
    validationSchema: Yup.object().shape({
      ...
      password: Yup.string(),
      terms: Yup.boolean().required().oneOf([true], "Checkbox Required"), 
     options: Yup.string().notOneOf(["Please Choose an Option"]).required()
    }),
